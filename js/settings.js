var settings = {
	textView:{
		...
		poshyEvents:[
			{wrapper:'scatterChart-div', klass:'circle', content:function(d){
				...
				var text = '<b>' + view.settings.xVar + '(x)</b>: ' + xVal + '</br>'
				text += '<b>' + view.settings.yVar + '(y)</b>: ' + yVal + '</br>'
				text += '<b>Turkish casualties</b>: ' + dat.text[0] + '</br>'
				text += '<b>Kurdish casualties</b>: ' + dat.text[1]+ '</br>'
				text += '<b>Civilians casualties</b>: ' + dat.text[2] + '</br>'
	...
	scatterChart:{
		...
		getTitleText:function(chart) {
			return "A mirror of the Kurdish-Turkish conflict?: Prevalence of nationalism as a topic in weekly religious sermons, 2001-2020"
		}
	},
	textChart: {
		id:'textChart', 
